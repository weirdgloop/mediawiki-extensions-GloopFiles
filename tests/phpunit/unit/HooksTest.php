...
namespace MediaWiki\Extension\GloopFiles\Tests;

use MediaWiki\Extension\GloopFiles\Hooks;

/**
 * @coversDefaultClass \MediaWiki\Extension\GloopFiles\Hooks
 */
class HooksTest extends \MediaWikiUnitTestCase {
	...
	public function testOnBeforePageDisplayVandalizeIsTrue() {
		$config = new \HashConfig( [
			'GloopFilesVandalizeEachPage' => true
		] );
	...
	public function testOnBeforePageDisplayVandalizeFalse() {
		$config = new \HashConfig( [
			'GloopFilesVandalizeEachPage' => false
		] );
		$outputPageMock = $this->getMockBuilder( \OutputPage::class )
			->disableOriginalConstructor()
			->getMock();
